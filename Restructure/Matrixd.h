/*
* A copy of the Matrixd from the OpenSceneGraph library
*/
...
class Matrixd
{
    public:
        ...
        inline int compare(const Matrixd& m) const;
        ...
        inline bool isNaN() const { return ::isNaN(_mat[0][0]) || ::isNaN(_mat[0][1]) || ::isNaN(_mat[0][2]) || ::isNaN(_mat[0][3]) ||
        ...
        void decompose( ::Vec3f& translation,
                        ::Quat& rotation, 
                        ::Vec3f& scale, 
                        ::Quat& so ) const;

        /** decompose the matrix into translation, rotation, scale and scale orientation.*/        
        void decompose( ::Vec3d& translation,
                        ::Quat& rotation, 
                        ::Vec3d& scale, 
                        ::Quat& so ) const;
...
inline int Matrixd::compare(const Matrixd& m) const
{
    const Matrixd::value_type* lhs = reinterpret_cast<const Matrixd::value_type*>(_mat);
    const Matrixd::value_type* end_lhs = lhs+16;
    const Matrixd::value_type* rhs = reinterpret_cast<const Matrixd::value_type*>(m._mat);
