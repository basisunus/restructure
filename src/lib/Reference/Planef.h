...
class Planef
{
    ...
    public:
        ...
        inline Planef() { _fv[0]=0.0; _fv[1]=0.0; _fv[2]=0.0; _fv[3]=0.0; _lowerBBCorner = 0; _upperBBCorner = 0; }
        inline Planef(const Planef& pl) { set(pl); }
        /// Constructor
        ...
        inline Planef(value_type a,value_type b,value_type c,value_type d) { set(a,b,c,d); }

        /// Constructor
        /** The plane can also be described as vec*[x,y,z,1].
          * @remark You may call osg::Plane::MakeUnitLength afterwards if the passed values are not normalized. */
        inline Planef(const Vec4f& vec) { set(vec); }
        /// Constructor
        /** The plane can also be described as vec*[x,y,z,1].
          * @remark You may call osg::Plane::MakeUnitLength afterwards if the passed values are not normalized. */
        inline Planef(const Vec4d& vec) { set(vec); }
        ...
        inline Planef(const vec_type& norm,value_type d) { set(norm,d); }
        ...
        inline Planef(const vec_type& v1, const vec_type& v2, const vec_type& v3) { set(v1,v2,v3); }
        ...
        /** This constructor initializes the internal values directly without any checking or manipulation.
          ...
          * @remark You may call osg::Plane::MakeUnitLength afterwards if the passed normal was not normalized. */
        inline Planef(const vec_type& norm, const vec_type& point) { set(norm,point); }

        inline Planef& operator = (const Planef& pl)
        {
        ...
        inline void set(const Planef& pl) { _fv[0]=pl._fv[0]; _fv[1]=pl._fv[1]; _fv[2]=pl._fv[2]; _fv[3]=pl._fv[3]; calculateUpperLowerBBCorners(); }
        ...
        inline void set(const vec_type& norm, double d) { set(norm[0],norm[1],norm[2],float(d)); }
        ...
        {
            value_type inv_length = float(1.0) / sqrt(_fv[0]*_fv[0] + _fv[1]*_fv[1]+ _fv[2]*_fv[2]);
            _fv[0] *= inv_length;
            _fv[1] *= inv_length;
            _fv[2] *= inv_length;
            _fv[3] *= inv_length;
        ...
        inline bool operator == (const Planef& plane) const { return _fv[0]==plane._fv[0] && _fv[1]==plane._fv[1] && _fv[2]==plane._fv[2] && _fv[3]==plane._fv[3]; }
        ...
        inline bool operator <  (const Planef& plane) const
        {
        ...
        inline float distance(const Vec3f& v) const
        {
            return _fv[0]*v.x()+
                   _fv[1]*v.y()+
                   _fv[2]*v.z()+
        ...
        inline float dotProductNormal(const Vec3f& v) const
        {
            return _fv[0]*v.x()+
                   _fv[1]*v.y()+
                   _fv[2]*v.z();
