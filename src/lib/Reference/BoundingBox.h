/*
* A copy of the BoundingBox from the OpenSceneGraph library
*/

#ifndef FL_BOUNDINGBOX
#define FL_BOUNDINGBOX 1
...
/** General purpose axis-aligned bounding box class for enclosing objects/vertices.
  * Bounds leaf objects in a scene such as Drawable objects. Used for frustum
  * culling etc.
*/
template<typename VT>
class BoundingBoxImpl
{
    public:
        ...
        {    return BoundingBoxImpl(std::max(xMin(),bb.xMin()),std::max(yMin(),bb.yMin()),std::max(zMin(),bb.zMin()),
